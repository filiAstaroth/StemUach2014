  ...
  <script type="text/javascript">
		...
		function c_alumnos(id_curso){
			...
			$.ajax({
					type: "POST",
					url: "ajax.php",
					data: "e_actividad=0&c_cuento=0&id_cuento=0&car_cue=0&id_cue=0&valores=0&c_curso=1&id_cur="+id_curso,
		...
		function c_actividades(){
		  ...
		  $.ajax({
				  type: "POST",
				  url: "ajax.php",
				  data: "c_curso=0&id_cur=0&c_cuento=0&id_cuento=0&car_cue=0&id_cue=0&e_actividad=1&valores="+valoresCheckbox,
				  success: function(datos){
					  //alert(datos);
		...
		function c_cuentos(actividad){
		  ...
		  $.ajax({
				  type: "POST",
				  url: "ajax.php",
				  data: "c_curso=0&id_cur=0&e_actividad=0&car_cue=0&id_cue=0&valores=0&c_cuento=1&id_cuento="+actividad+"&id_curso="+curso,
				  success: function(datos){
					  //alert(datos);
					  $("#cuentos").html(datos);
					  $(".v_cuentos").fancybox({  						
  ...
  <div id="main">
      ...
      <div class="content">
      	<div id="d_cursos">
            ...
            <div id="acciones_c" class="acciones">
                <p id="btn_nuevoCurso"><input type="button" value="Nuevo Curso"/></p>                
            </div>
        </div>
        <div id="d_lisAlumnos" style="display:none">
            ...
            <div id="acciones_a" class="acciones">
            	<p id="btn_nuevoAlumno"><input type="button" value="Nuevo Alumno"/></p>
                <p id="btn_escogerActividad"><input type="button" value="Escoger Actividad" onclick="c_actividades()"/></p>
            </div>
        </div>        
      </div>
    </div>
    ...
    <div id="nuevo_curso" style="display:none">
      ...
      <table width="400" border="1">
            <tr>
                <td width="120">Nombre del Curso</td>
                <td><input name="cur_nombre" id="cur_nombre" type="text" /></td>
            </tr>
      </table>
	  <p id="btn_agregarCurso"><input type="button" value="Agregar Curso"/></p>
    </div>
    ...
    <div id="nuevo_alumno" style="display:none">
	  ...
	  <p id="btn_agregarAlumno"><input type="button" value="Agregar Alumno"/></p>
    </div>
    ...
    <div id="d_actividades" style="display:none">
        <div id="lista_actividades" class="d_activity">
          ...
          <p id="btn_agregarActividad"><input type="button" value="Agregar Actividad"/></p>
        </div>
        <div id="desglose_actividades" class="d_activity" style="display:none">
          <h2>Lista de Cuentos</h2>
		  <div id="cuentos">
          </div>	
          <p id="btn_agregarCuento"><input type="button" value="Agregar Cuento"/></p>
        </div>
        <div id="vacio"></div>
    </div>                   
<!--    <footer>
